...
namespace attendance_api.Migrations
{
    ...
    [Migration("20260221065455_AddWFHAndPerformanceFeatures")]
    partial class AddWFHAndPerformanceFeatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("attendance_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$e9fReega9mXPqzBBcZ98dO8gCFqw4k86GLdY.vWDFpHrIx6Tyhc7a",
                            Role = "admin",
                            RoleId = 1,
                            UserName = "Admin"
                        });
