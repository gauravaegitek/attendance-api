...
//                 var selfiePath = await _fileService.SaveSelfieAsync(dto.SelfieImage, selfieFolderPath);
...
//                         inTime = new { ticks = dto.InTime.Value.ToString(@"HH\:mm\:ss") },
...
//                         outTime = new { ticks = dto.OutTime.Value.ToString(@"HH\:mm\:ss") },
...
//             try
//             {
//                 // Auto-populate UserId from JWT token (for tracking who requested)
//                 var userIdClaim = User.FindFirst(System.Security.Claims.ClaimTypes.NameIdentifier);
//                 if (userIdClaim == null)
//                 {
//                     return Unauthorized(new ApiResponse<List<AttendanceSummaryDto>>
...
//                     });
//                 }
//                 // We get the userId but don't need to use it for filtering, just for tracking
...
//                     query = query.Where(a => a.AttendanceDate >= dto.FromDate.Value.Date);

//                 if (dto.ToDate.HasValue)
//                     query = query.Where(a => a.AttendanceDate <= dto.ToDate.Value.Date);
...
//                 // Fixed: Remove HasValue checks since FromDate and ToDate are DateTime (not nullable)
...
//                 // REQUIREMENT 4: Validate Biometric Data (Required for both In and Out)
...
//                 // REQUIREMENT 3: Conditional Selfie Based on Role
...
//                         InLocationAddress = dto.LocationAddress,
//                         InSelfie = selfiePath,
//                         InBiometric = dto.BiometricData, // REQUIREMENT 4: Store biometric
//                         CreatedOn = DateTime.Now
//                     };
...
//                     existingAttendance.InLocationAddress = dto.LocationAddress;
//                     existingAttendance.InSelfie = selfiePath;
//                     existingAttendance.InBiometric = dto.BiometricData; // REQUIREMENT 4
//                 }
...
//                 attendance.OutLocationAddress = dto.LocationAddress;
//                 attendance.OutSelfie = selfiePath;
//                 attendance.OutBiometric = dto.BiometricData; // REQUIREMENT 4: Store biometric
//                 attendance.UpdatedOn = DateTime.Now;
...
//                 // REQUIREMENT 5: PDF Issue Fix - Check if data exists
...
//                     {
//                         attendanceDate = dto.AttendanceDate.ToString("dd-MMM-yyyy"),
//                         inTime = dto.InTime.Value.ToString(@"hh\:mm\:ss"),      // ✅ FIXED: hh (lowercase) for TimeSpan
//                         location = dto.LocationAddress,
//                         biometricCaptured = true,
//                         selfieCaptured = selfiePath != null
//                     }
...
//                     {
//                         attendanceDate = dto.AttendanceDate.ToString("dd-MMM-yyyy"),
//                         outTime = dto.OutTime.Value.ToString(@"hh\:mm\:ss"),    // ✅ FIXED: hh (lowercase) for TimeSpan
//                         totalHours = attendance.TotalHours?.ToString("0.00"),
//                         location = dto.LocationAddress,
//                         biometricCaptured = true,
//                         selfieCaptured = selfiePath != null
