    ...
    public class NotificationController : BaseController
    {
        ...
        public async Task<ActionResult<ApiResponse<List<NotificationDto>>>> GetMyNotifications()
        {
            try
            {
                ...
                return ApiOk("Notifications fetched successfully", notifications);
            }
            catch (Exception ex) { return ApiServerError("Failed to fetch notifications", ex); }
        }
        ...
        public async Task<ActionResult<ApiResponse<string>>> MarkAsRead(int notificationId)
        {
            try
            {
                ...
                return ApiOk("Marked as read", "read");
            }
            catch (Exception ex) { return ApiServerError("Failed to mark as read", ex); }
        }
        ...
        public async Task<ActionResult<ApiResponse<string>>> MarkAllAsRead()
        {
            try
            {
                ...
                return ApiOk("All notifications marked as read", "done");
            }
            catch (Exception ex) { return ApiServerError("Failed to mark all as read", ex); }
        }
        ...
        public async Task<ActionResult<ApiResponse<int>>> GetUnreadCount()
        {
            try
            {
                ...
                return ApiOk("Unread count", count);
            }
            catch (Exception ex) { return ApiServerError("Failed to get unread count", ex); }
        }
        ...
        public async Task<ActionResult<ApiResponse<string>>> SendNotification([FromBody] SendNotificationDto dto)
        {
            try
            {
                ...
                return ApiOk("Notification sent successfully", "sent");
            }
            catch (Exception ex) { return ApiServerError("Failed to send notification", ex); }
        }
    }
}